...
while (runLength < 0)
{
    ...
    int index = 0;                                                                   //for loop example
    for (int index = 0; index < 5; ++index)                                          //only in for loops are you allowed to declare your loop variant inside your for loop (keeps it in scope)
    {
        std::string genre;

        std::cout << "Enter the genre (or blank to continue): " << std::endl;
        std::getline(std::cin, genre);
        if (genre == "")
            //done = true;
            //index = 5;                                                             //not the best, cause cause mucking witht he variable
            break;                                                                  //breaks out of loop

        else if (genre == "")
            continue;                                                           //continue stops current interration then tries again, but does no exit the loop
    ...
    /*while (!done && count < 5)
        ...
        */
        ...
        std::cout << "Genres" << genres << std::endl;                                                                     //std::cout << "Is Classic? " << isClassic << std::endl;
                                                                                /*if (isClassic)
